...
# 🚀 Arcade Hero: Enter the BigQuery Table |#ARC130|


Open your **Google CloudShell** and run the following commands to start your lab:


```bash
gsutil cp gs://cloudhustlers/ARC130.sh
