...
3. Give this signature `CloudHustlers` name, then click `Create`.

4. In the Signature defaults section, use the dropdown menu under `For New Emails Use` and select `CloudHustlers`.
...
3. For `App name`, type `CloudHustlers` to name your app.
